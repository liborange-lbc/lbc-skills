...
6. **GitNexus优先** — 代码分析和影响面评估优先使用 `gitnexus` 命令
...
AgentID 注册表:
  ...
  → 详见 [reference/Phase01-08-执行日志规范.md](reference/Phase01-08-执行日志规范.md)
```
...
详细清单 → [reference/Phase01-需求面试清单.md](reference/Phase01-需求面试清单.md)
...
详细指南 → [reference/Phase02-代码阅读指南.md](reference/Phase02-代码阅读指南.md) + [reference/Phase02-知识查阅规则.md](reference/Phase02-知识查阅规则.md)
...
架构约束 → [reference/Phase03-架构约束.md](reference/Phase03-架构约束.md)  
文档模板 → [reference/Phase03-设计文档模板.md](reference/Phase03-设计文档模板.md)
...
|-------|------|--------------|
| design-reviewer | 架构合理性 | [reference/Phase04&06-评审检查清单.md](reference/Phase04&06-评审检查清单.md) §系分-架构 |
...
修正协议 → [reference/Phase04&06-修正循环协议.md](reference/Phase04&06-修正循环协议.md)
...
详细指南 → [reference/Phase05-编码实现指南.md](reference/Phase05-编码实现指南.md)
...
| Agent | 视角 | 详细checklist |
|-------|------|--------------|
| code-quality-reviewer | 代码质量 | [reference/Phase04&06-评审检查清单.md](reference/Phase04&06-评审检查清单.md) §代码-质量 |
...
详细指南 → [reference/Phase07-测试验证指南.md](reference/Phase07-测试验证指南.md)
...
模板 → [reference/Phase08-交付报告模板.md](reference/Phase08-交付报告模板.md)
